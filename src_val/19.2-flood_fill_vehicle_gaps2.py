...
#rellenamos segundo las manchas de vegetation vertical
...
color_target = np.array([107,142,35]) #vertical vegetation
...
for selec in tqdm(range(n_images)):    
    ...
    # =============================================================================
    cimg = imageio.imread('reduced_cluster_v10/reduced_'+str(selec)+'.png')
    final_img = cimg.copy()
...
# =============================================================================
        ...
        if d_count[id_car]+d_count[id_shadow] >= 0.90 * len(neigh_labels):
    ...
    im.save('reduced_cluster_v11/reduced_'+str(selec)+'.png')
