...
color_target = np.array([0,60,100]) #azul cyan bricks
...
for selec in tqdm(range(n_images)):    
    ...
    # =============================================================================
    cimg = imageio.imread('reduced_cluster_v6/reduced_'+str(selec)+'.png')
    final_img = cimg.copy()
...
# =============================================================================
        ...
        if d_count[-1]+d_count[id_wheel]+d_count[id_car]+d_count[id_shadow]+d_count[id_road]+d_count[id_ego] >= 0.50 * len(neigh_labels):
    ...
    im.save('reduced_cluster_v7/reduced_'+str(selec)+'.png')
